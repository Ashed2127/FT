        ...
        <div class="register-form-container">
            <form id="registerForm" @submit="handleSubmit" novalidate autocomplete="off">
                ...
                <div class="form-group">
                    <label for="aEmail">Enter your email:
                    </label>
                    <input type="email" name="aEmail" placeholder="example@gmail.com" id="aEmail" class="form-control"
                        v-model="registerObj.email" />
                    <p class="error-mess" v-if="errorObj.emailErr.length > 0">{{ errorObj.emailErr[0] }}</p>
                </div>

                <div class="form-group">
                    <label for="aPass">Enter your password:
                    </label>
                    <input type="password" name="aPass" placeholder="enter your password" id="aPass"
                        class="form-control" v-model="registerObj.pass" />
                    <p class="error-mess" v-if="errorObj.passErr.length > 0">{{ errorObj.passErr[0] }}</p>
                </div>

                <div class="form-group">
                    <label for="aPassConfirm">Check your password again:
                    </label>
                    <input type="password" name="aPassConfirm" placeholder="enter your password again" id="aPassConfirm"
                ...
                <div class="form-group">
                    ...
                    <p>have an account? <router-link @click="scrollToTop()" to="dplogin">login</router-link>
                    </p>
                </div>
            </form>
        </div>
