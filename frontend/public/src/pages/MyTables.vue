            ...
            <div v-for="book in filterBooks.slice().reverse()" class="card" :key="book.book_id">
                ...
                <div class="card-body">
                    <div class="steps d-flex flex-wrap flex-sm-nowrap justify-content-between">
                        ...
                        <div class="step" :class="book.book_status >= 3 && book.book_status < 4? 'completed' : ''">
                            <div class="step-icon-wrap">
                                <div class="step-icon"><i class="fa-solid fa-chair"></i></div>
                            </div>
                            <h4 class="step-title">Reserved</h4>
                        </div>
                        <div class="step" :class="book.book_status >= 4 ? 'completed' : ''">
                            <div class="step-icon-wrap">
                                <div class="step-icon"><i class="fa-solid fa-empty-set"></i></div>
                            </div>
...
<!-- 
        <OrderDetails v-if="showOrderDetails" :book="sendId">
